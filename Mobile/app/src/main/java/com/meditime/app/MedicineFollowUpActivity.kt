...
class MedicineFollowUpActivity : BaseMenuActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_medicine_follow_up)
        ...
        findViewById<TextView>(R.id.titleText).text = getString(R.string.medicine_follow_up_title)
    }

    fun goBackToMedicineDetailActivity(view: View) {
